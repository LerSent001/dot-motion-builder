...
- `pnpm test` covers type checking, 22 motion presets across multiple grid sizes, loop boundaries, masks, speed scaling, special text, shapes, sequences, and both generators.
